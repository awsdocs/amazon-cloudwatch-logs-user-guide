...
If you want to manage the keys used for encrypting and decrypting your logs, use customer master keys \(CMK\) from AWS Key Management Service\. For more information, see [Encrypt log data in CloudWatch Logs using AWS Key Management Service](encrypt-log-data-kms.md)\.
