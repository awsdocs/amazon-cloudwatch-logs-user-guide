# Using CloudWatch Logs with an AWS SDK<a name="sdk-general-information-section"></a>
...
For examples specific to CloudWatch Logs, see [Code examples for CloudWatch Logs](service_code_examples.md)\.
