...
1. Associate the permissions policy with the role using the following [put\-role\-policy](http://docs.aws.amazon.com/cli/latest/reference/iam/put-role-policy.html) command:
